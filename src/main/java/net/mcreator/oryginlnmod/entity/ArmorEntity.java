...
import net.mcreator.oryginlnmod.entity.renderer.ArmorRenderer;
import net.mcreator.oryginlnmod.OryginlnModModElements;

@OryginlnModModElements.ModElement.Tag
public class ArmorEntity extends OryginlnModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("armor").setRegistryName("armor");
	public ArmorEntity(OryginlnModModElements instance) {
		super(instance, 12);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ArmorRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.COMBAT)).setRegistryName("armor_spawn_egg"));
	}
