...
public class HalosolgerarmoredEntity extends OryginlnModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("halosolgerarmored").setRegistryName("halosolgerarmored");
	public HalosolgerarmoredEntity(OryginlnModModElements instance) {
		super(instance, 13);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HalosolgerarmoredRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.COMBAT)).setRegistryName("halosolgerarmored_spawn_egg"));
	}
