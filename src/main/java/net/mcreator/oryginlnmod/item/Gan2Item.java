...
import net.mcreator.oryginlnmod.entity.renderer.Gan2Renderer;
...
public class Gan2Item extends OryginlnModModElements.ModElement {
	@ObjectHolder("oryginln_mod:gan_2")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletgan_2").setRegistryName("entitybulletgan_2");
	public Gan2Item(OryginlnModModElements instance) {
		super(instance, 9);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Gan2Renderer.ModelRegisterHandler());
	}
