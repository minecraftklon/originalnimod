...
import net.mcreator.oryginlnmod.procedures.BulletsProcedure;
import net.mcreator.oryginlnmod.entity.renderer.GunRenderer;
...
public class GunItem extends OryginlnModModElements.ModElement {
	@ObjectHolder("oryginln_mod:gun")
	...
	public GunItem(OryginlnModModElements instance) {
		super(instance, 7);
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 3.9999999999999996, 0);
						...
						}
						{
							...
							BulletsProcedure.executeProcedure($_dependencies);
						}
					}
