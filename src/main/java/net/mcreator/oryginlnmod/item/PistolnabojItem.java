...
public class PistolnabojItem extends OryginlnModModElements.ModElement {
	@ObjectHolder("oryginln_mod:pistolnaboj")
	public static final Item block = null;
	public PistolnabojItem(OryginlnModModElements instance) {
		super(instance, 16);
	}
