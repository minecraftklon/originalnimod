...
package net.mcreator.oryginlnmod.world.biome;
...
import net.mcreator.oryginlnmod.entity.CovenantElitepistolEntity;
import net.mcreator.oryginlnmod.entity.CovenantEliteEntity;
...
public class Biom1Biome extends OryginlnModModElements.ModElement {
	public static Biome biome;
	public Biom1Biome(OryginlnModModElements instance) {
		super(instance, 25);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.STRIPPED_CRIMSON_STEM.getDefaultState()),
										...
										new ForkyTrunkPlacer(7, 2, 2), new TwoLayerFeature(1, 0, 2))).setDecorators(
				...
				event.getRegistry().register(biome.setRegistryName("oryginln_mod:biom_1"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("biom_1_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("biom_1_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
