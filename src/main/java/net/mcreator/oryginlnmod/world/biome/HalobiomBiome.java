...
public class HalobiomBiome extends OryginlnModModElements.ModElement {
	public static Biome biome;
	public HalobiomBiome(OryginlnModModElements instance) {
		super(instance, 1);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.GRAY_CONCRETE.getDefaultState(),
								Blocks.INFESTED_CRACKED_STONE_BRICKS.getDefaultState(), Blocks.INFESTED_CRACKED_STONE_BRICKS.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("oryginln_mod:halobiom"));
			}
		}
	}
	@Override
